...
const Billing = () => {
  return (
    <div className='flex md:flex-row sm:flex-col-reverse sm:py-10 py-6 justify-between w-[80%] sm:w-full sm:px-[20px] gap-[40px]'>
        <div>
        ...
        <div className='flex justify-center items-start flex-1 flex-col'>
            ...
            <p className='max-w-[470px] sm:w-full mt-5 font-poppins font-normal text-dimWhite text-[18px] sm:text-[15px] leading-[30.8px]'>
