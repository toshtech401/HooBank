...
const Hero = () => {
  return (
    <div className='flex md:flex-row justify-between w-full'>
        <div className='flex justify-center w-full items-start flex-col xl:px px-6'>
        ...
        <div className=' justify-center items-center flex md:my-0 my-10 w-[80%]'>
            <Image height={300} width={400} quality={100} src={"/robot.png"} className='w-full h-[80vh] '/>
        </div>
    </div>
  )
}
