  ...
  return (
    <div className='sm:py-16 py-6 flex justify-center items-center flex-col relative w-[80%]'>
        <div className="w-full flex justify-between sm:flex-col md:flex-col items-center sm:mb-16 mb-6 relative z-[1]">
            <h2 className='font-poppins font-semibold xs:text-[48px] text-[40px] text-white xs:leading-[76.8px] leading-[66.8px] w-full'>What People are <br className="sm:hidden" /> saying about us</h2>
        ...
        <div  className="flex justify-between w-full sm:flex-col md:grid md:grid-cols-2 gap-[55px] md:mr-10 sm:mr-5 mr-0 my-5">
