...
const Footer = () => {
  return (
    <div className='flex w-[80%] justify-between mt-[40px] sm:mt-[20px] py-4 sm:flex-col md:grid md:grid-cols-2 sm:gap-[40px]'>
        <div>
        ...
        <div className='flex flex-col gap-2'>
            <h4 className="font-poppins font-medium text-[20px] leading-[27px] text-white">Useful Links</h4>
            <ul>
        ...
        <div className='flex flex-col gap-2'>
            <h4 className="font-poppins font-medium text-[20px] leading-[27px] text-white">Community</h4>
            <ul>
        ...
        <div className='flex flex-col gap-2'>
            <h4 className="font-poppins font-medium text-[20px] leading-[27px] text-white">Partner</h4>
            <ul>
